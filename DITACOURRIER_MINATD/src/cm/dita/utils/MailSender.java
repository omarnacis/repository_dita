   ...
   // Constructeur n�1: Connexion au serveur mail
    public MailSender(final String host, final int port, final String userName,final String password, final boolean ssl){
	    ...
	    if (null == userName || null == password) {
	        ...
	        //System.out.println(_session.getProperties());
	    }
	}
...
/*        final MailMessage msg = new MailMessage();
        final MailSender mail2 = new MailSender("smtp.mail.yahoo.com", 465,"omarnacis@yahoo.fr", "", true);
        
        // Message avec texte html + images incluses + pi�ces jointes
        msg.setFrom(new InternetAddress("omarnacis@yahoo.fr", "Djiomou"));
        msg.setTo("omarnacis@yahoo.fr");
        msg.setSubject("Salut Omar Nacis DJIOMOU");
        msg.setContent("Les gars je back", true);
