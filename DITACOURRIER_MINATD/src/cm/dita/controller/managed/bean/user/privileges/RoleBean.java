...
*/
 	...
 	public void create(ActionEvent actionEvent) {
    	...
    	try{	
		        ...
		        mouchardRessourceService.tracage("Ajout du r�le "+role.getRoleName(), "ajout",role.getDateUseToSortData(), "Role");
    		 ...
    		 e.printStackTrace();
    		 mouchardRessourceService.tracage("Echec ajout du r�le "+role.getRoleName(), "ajout",role.getDateUseToSortData(), "Role");
  ...
  */
 	 ...
 	 public void update(ActionEvent actionEvent) {
    	 ...
    	 try{
    		 	...
    		 	roleGroupService.saveGroup2Role(this.role, selectedGroups);
		    	init();//mise � jour de la liste
		    	 mouchardRessourceService.tracage("Modification du r�le "+role.getRoleName(), "modification",role.getDateUseToSortData(), "Role");
 	    ...
 	    //	}
    		 ...
    		 mouchardRessourceService.tracage("Echec modification du r�le"+role.getRoleName(), "modification",role.getDateUseToSortData(), "Role");
 	...
 	public void delete(ActionEvent actionEvent) {
       ...
       try{
    	   if((roleUserService.getCountRoleUser(role.getIdentifier())>0)){
			   mouchardRessourceService.tracage(" Erreur de suppression du r�le ("+role.getRoleName()+") ", "suppression",role.getDateUseToSortData(), "Role");
    		   ...
    		   roleService.deleteVersusDesabled(role);
    	   		mouchardRessourceService.tracage("Suppression du r�le"+role.getRoleName()+"("+role.getIdentifier()+")", "suppression",role.getDateUseToSortData(), "Role");
  		 ...
  		 e.printStackTrace();
  		mouchardRessourceService.tracage("Echec de suppression du r�le"+role.getRoleName()+"("+role.getIdentifier()+")", "suppression",role.getDateUseToSortData(), "Role");
 	...
 	public void validateName(FacesContext context, UIComponent component, Object value) throws ValidatorException {
 		 ...
 		 if(roleService.userExiste(role)){
 			 mouchardRessourceService.tracage("Tentative d'ajout du r�le (nom existant) "+role.getRoleName(), "ajout",role.getDateUseToSortData(), "Role");
